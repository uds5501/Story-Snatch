...
def after_in(user,name):
    ...
    print "PLEASE STOP TAMPERING THE DATA BASE, SET THE USERS.TXT BACK TO NORMAL.. OR ELSE :("
                    
                                    


def home():
    secu=security_2.check()
    while secu is True:
        print"****************************************************************************************************************************"
        ...
        print "\n\n                     1.LOGIN                     2.SIGN UP                     3.ABOUT US                     4.EXIT"
        while True:
            try:
                x=int(raw_input("--->  "))
                if x==1:
